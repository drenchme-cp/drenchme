...
<table cellpadding="2" class="registeInfo" width="100%">
                            ...
                            <tr style="color: #000000">
                                ...
                                <td style="height: 28px">
                                    <asp:TextBox ID="XueXiao" runat="server" Width="166px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="XueXiao"
                                        ErrorMessage="必填"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr style="color: #000000">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="pic"
                                        ErrorMessage="必填"></asp:RequiredFieldValidator></td>
                            </tr>
