<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageManger.aspx.cs" Inherits="Teachter_PageManger" %>
                    ...
                    &nbsp;<asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="试卷名称">
                                <ItemTemplate>
                                    <asp:Label ID="ShiJuanName" runat="server" Text='<%# Bind("ShiJuanName") %>' Width="560px"></asp:Label>
                                </ItemTemplate>
