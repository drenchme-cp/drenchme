                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                               <asp:TemplateField HeaderText="标题">
                                <ItemTemplate>
                                    <asp:Label ID="TitleName" runat="server" Text='<%# Bind("TitleName") %>' Width="155px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                        
                             
                            <asp:TemplateField HeaderText="下载文件">
                                <ItemTemplate>
                                    <a href='../files/<%#Eval("FilePath") %>' target="_blank">下载文件</a>
                                </ItemTemplate>
