      ...
      添加课件</td>
        ...
        <table align="center"  border="0" cellpadding="2" cellspacing="1"
            style="margin-top: 8px" width="98%">
               ...
               <td style="WIDTH: 124px; HEIGHT: 21px" class="td2" align="center">
                   标题：</td>
             ...
             <tr>
               ...
               <td style="WIDTH: 124px; HEIGHT: 54px" class="td2" align="center">
                   内容说明：</td>
               <td style="WIDTH: 953px; HEIGHT: 54px" class="td2"  colspan="7">
                   <textarea id="content1" runat="server" rows="8" style="visibility: hidden;
                       width: 99%; height: 200px"></textarea></td>       
