<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTiMu.aspx.cs" ValidateRequest="false" EnableEventValidation="false"     Inherits="Teachter_AddTiMu" %>
                    ...
                    &nbsp;<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;
                        ...
                        <tr>
                            <td align="center" style="width: 131px; height: 25px">
                                分数：</td>
                            <td style="height: 25px">
                                <asp:TextBox ID="txtScore" runat="server" ReadOnly="True" Width="36px">10</asp:TextBox></td>
                        </tr>
                        <tr>
