<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiMuLists.aspx.cs" Inherits="Teachter_TiMuLists" %>
                    ...
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="考试题目">
                                <ItemTemplate>
                                    <asp:Label ID="Title" runat="server" Text='<%# Bind("Title") %>' Width="280px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="题目类型">
                                <ItemTemplate>
                                    <asp:Label ID="Type" runat="server" Text='<%# Bind("Type") %>' Width="79px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <a href='ModifyTiMu.aspx?Type=<%#DataBinder.Eval(Container.DataItem,"Type") %>&id=<%#DataBinder.Eval(Container.DataItem,"id") %>'>
                                        修改 </a>
                                </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
